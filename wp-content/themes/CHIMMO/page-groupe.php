...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="header-container apropos">
            <img src="<?php echo get_field('image')['sizes']['home_top']; ?>" class="bg">
            <div class="container ninety-five-vh xs-fifty-vh aproposimg">
                <header class="header clearfix">
                    <div class="logo-container">
                        <a href="javascript:;">
                            <img src="<?php echo get_template_directory_uri() ?>/images/icons/logo.svg" alt="Logo CHIMMO" class="logo"
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item home">
                                <a href="<?php the_permalink(6); ?>" class="active">
                                    <img src="<?php echo get_template_directory_uri() ?>/images/icons/home-minimal.svg" alt="Home"
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-sm-18 col-xs-18"><div class="flex-content">
                <?php $flex= get_field('contenu_flexible_bis');
                ...
                <div class="col-12 text1 col-sm-18 col-xs-18"><div class="flex-content">
